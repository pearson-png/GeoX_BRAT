...
importlib.reload(FindBraidedNetwork)
...
def main(
    ...
    if road != None and valley_bottom != None:
...
def add_drain_area_to_inputs_xml(xml_file, drainage_area, proj_path):
    ...
    if element != None: # if the flow acc is already in the xml file, we don't need to do anything
        return
