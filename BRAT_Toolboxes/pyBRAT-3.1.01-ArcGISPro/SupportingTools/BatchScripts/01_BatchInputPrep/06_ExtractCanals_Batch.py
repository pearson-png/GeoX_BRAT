...
# default is to overwrite
    ...
    # list all folders in parent folder - note this != recursive
    ...
    for dir in dir_list:
        ...
        # extract canals and ditches for all watersheds
        if not os.path.exists(canal_shp) or overwrite is True:
            ...
            try:
                ...
                # save output only if any flowlines were selected
