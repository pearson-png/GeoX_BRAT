...
class BRAT_braid_handler(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(BRAT_Braid_Handler)
        importlib.reload(StreamObjects)
...
class Conservation_Restoration_tool(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(Conservation_Restoration)
...
class Data_Capture_Validation_tool(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(Data_Capture_Validation)
...
class Drainage_Area_Check_tool(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(StreamObjects)
        importlib.reload(Drainage_Area_Check)
...
class Layer_Package_Generator_tool(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(Layer_Package_Generator)
...
class Collect_Summary_Products_tool(object):
    ...
    def execute(self, p, messages):
        """The source code of the tool."""
        importlib.reload(Collect_Summary_Products)
