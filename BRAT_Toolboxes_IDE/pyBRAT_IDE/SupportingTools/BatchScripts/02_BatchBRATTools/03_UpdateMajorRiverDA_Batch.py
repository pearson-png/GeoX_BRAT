...
# da_csv_path - filepath to CSV holding upstream drainage area information
...
da_csv_path = r"C:\Users\ETAL\Desktop\GYE_BRAT\wrk_Data\00_Projectwide\ModelParameters\GYE_Upstream_DA.csv"
...
def update_da(inNetwork, inDict):
    ...
    for stream in streamList:
        ...
        if min_daValues <= daValue:
            ...
            print("DA values have already been updated for: " + stream + ". If this != the case, update manually.")
...
def main():
    ...
    # list all folders in parent folder path - note this != recursive
        ...
        if os.path.exists(brat_table):
            ...
            if sub_daDict != None:
                try:
                    ...
                    print('WARNING: Updating drainage area failed for ' + dir + '. Exception thrown was:')
                    print(err)
        else:
