...
Reserve the `Latest Release` (currently  BRAT `3.0.1`) for the latest stable, tested and documented release. If it != stable, tested or documented, leave it as BETA in a `Pre Release`.
