...
Note: If 'us_200' != yet available for your study area you can use 'us_140'.
...
Note: While LANDFIRE data is a good source for existing and historic vegetation in the USA other datasets can be used where LANDFIRE != available.
